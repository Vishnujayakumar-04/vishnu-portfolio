...
const TimelineSection = ({ title, items }: TimelineSectionProps) => {
  return (
    <section className="container mx-auto px-2 sm:px-4 lg:px-6 py-16">
        ...
        <div className="relative w-full pt-8">
          ...
          {items.map((item, index) => (
            ...
            >
              ...
              <div className="bg-background-accent/10 rounded-xl p-6 backdrop-blur-sm border border-text-accent/10">
                  ...
                  <div className="flex flex-col items-start md:items-end mt-2 md:mt-0 md:ml-8">
                    ...
                    {item.certificateLink && (
                      <a
                        ...
                        className="inline-block px-4 py-2 bg-gradient-to-r from-[#FFD700] via-[#FFA500] to-[#FF4500] hover:opacity-90 text-white text-sm rounded-md shadow font-semibold mt-2"
                      >
                        View Certificate
                      </a>
                    )}
