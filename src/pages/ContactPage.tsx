        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10">
          ...
          >
            ...
            <div className="space-y-6 sm:space-y-8 mb-8 sm:mb-10">
              ...
              >
                <div className="w-12 h-12 rounded-full bg-background-accent flex items-center justify-center hover:bg-gradient-to-r hover:from-[#FFD700] hover:via-[#FFA500] hover:to-[#FF4500] hover:shadow-lg hover:shadow-[#FFA500]/50 hover:scale-110 transition-all duration-300">
                  <MapPin className="text-text-accent" />
                </div>
                <div>
                  <h3 className="text-xl font-display font-semibold text-text-primary mb-2">Location</h3>
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-display font-semibold text-text-primary mb-2">Email</h3>
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-display font-semibold text-text-primary mb-2">Phone</h3>
