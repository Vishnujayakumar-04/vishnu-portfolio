        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              Motivated and detail-oriented Computer Science student with hands-on experience in academic projects, internships, and technical workshops. 
              I enjoy learning and building simple, functional digital solutions across web and mobile platforms. 
              I also work on creative digital design, combining visuals with technology to create clean and user-friendly experiences. 
              Always improving, exploring new tools, and developing practical skills in web development, mobile application development, UI/UX, and creative content design.
              </p>
